...
def get_nice_response():
    """ If we wanted to initialize the session to have some attributes we could
    add those here
    """
    session_attributes = {}
    card_title = "Something Nice"
    ...
    speech_output = "hmm... wie wärs mit " + nice_responses[random.randint(0,len(nice_responses)-1)]
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Anscheinend bist Du eingeschlafen." + speech_output
    should_end_session = False
...
def get_help_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Die Hilfe ist noch nicht implementiert!"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Anscheinend bist Du eingeschlafen." + speech_output
    should_end_session = False
...
def handle_session_end_request():
    ...
    speech_output = "Cool. Danke. Over. Aus!"
